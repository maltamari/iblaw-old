  ...
  return (
    <div className="relative w-full">
      {/* Hero Image Section */}
        ...
        {/* Hero Text */}
        <div className={cn("relative z-10 flex items-center h-full max-w-7xl mx-auto ",aboutClass)}>
          <div className="max-w-5xl">
            <h1 className={cn("text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight ",textClass)}>
              {text}
            </h1>
